...
export type StorageHash =
  StorageHashBase<'1bbb4f8d65643c7753c9422de5625fc839419bfa4b601846ac500d9b234d4c11'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      ...
      readonly role: 'OWNER' | 'ADMIN' | 'SUPERVISOR' | 'WORKER';
      readonly active: CodecTypes['pg/bool@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly checklistAnswer: {
              ...
              indexes: readonly [
                {
                  readonly name: 'checklistAnswer_scheduledServiceId_idx_3974c425';
                  readonly prefix: 'checklistAnswer_scheduledServiceId_idx';
                  readonly columns: readonly ['scheduledServiceId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'checklistAnswer_checklistItemId_idx_93aa93e9';
                  readonly prefix: 'checklistAnswer_checklistItemId_idx';
                  readonly columns: readonly ['checklistItemId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'checklistAnswer';
                    readonly columns: readonly ['scheduledServiceId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly document: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'document_workerId_idx_0b8f3a7c';
                  readonly prefix: 'document_workerId_idx';
                  readonly columns: readonly ['workerId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly evidence: {
              ...
              indexes: readonly [
                {
                  readonly name: 'evidence_scheduledServiceId_idx_3974c425';
                  readonly prefix: 'evidence_scheduledServiceId_idx';
                  readonly columns: readonly ['scheduledServiceId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly report: {
              ...
              indexes: readonly [
                {
                  readonly name: 'report_scheduledServiceId_idx_3974c425';
                  readonly prefix: 'report_scheduledServiceId_idx';
                  readonly columns: readonly ['scheduledServiceId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly scheduledService: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'scheduledService_serviceTypeId_idx_f0d20246';
                  readonly prefix: 'scheduledService_serviceTypeId_idx';
                  readonly columns: readonly ['serviceTypeId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'scheduledService_workerId_idx_0b8f3a7c';
                  readonly prefix: 'scheduledService_workerId_idx';
                  readonly columns: readonly ['workerId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly serviceObservation: {
              ...
              indexes: readonly [
                {
                  readonly name: 'serviceObservation_scheduledServiceId_idx_3974c425';
                  readonly prefix: 'serviceObservation_scheduledServiceId_idx';
                  readonly columns: readonly ['scheduledServiceId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'serviceObservation';
                    readonly columns: readonly ['scheduledServiceId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly user: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['tenantId', 'email'] }];
              indexes: readonly [
                {
          ...
          readonly valueSet: {
            readonly UserRole: {
              ...
              readonly values: readonly ['OWNER', 'ADMIN', 'SUPERVISOR', 'WORKER'];
            };
          };
        };
      };
            ...
            readonly relations: {
              readonly checklistAnswers: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['checklistItemId'];
                };
              };
              readonly serviceType: {
                readonly to: {
          ...
          readonly ScheduledService: {
            ...
            readonly relations: {
              readonly checklistAnswers: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['scheduledServiceId'];
                };
              };
              readonly customer: {
                readonly to: {
          ...
          readonly Worker: {
            ...
            readonly relations: {
              readonly documents: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['workerId'];
                };
              };
              readonly scheduledServices: {
                readonly to: {
        ...
        readonly enum: {
          readonly UserRole: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'WORKER'; readonly value: 'WORKER' },
            ];
          };
        };
      };
